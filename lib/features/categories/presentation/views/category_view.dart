...
import 'package:fashionapp/features/categories/presentation/hooks/fetch/fetch_category_products.dart';
...
class CategoryView extends HookWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final product = fetchCategoryProducts(
      context.read<CategoryNotifier>().getId,
    );
